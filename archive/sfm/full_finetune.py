...
CHECKPOINT_PATH = CKPT_DIR / "sfm_finetune_checkpoint.pth"
BEST_MODEL_PATH = CKPT_DIR / "sfm_finetune_best.pth"
...
NUM_CLASSES  = 6
BATCH_SIZE   = 2            # ViT-Base full + 5ch + 384 + AMP: VRAM sinirinda
ACCUM_STEPS  = 12           # eff batch = 24 (v9 ile ayni)
NUM_EPOCHS   = 60
PATIENCE     = 15
WARMUP_EPOCHS = 5
BASE_LR_ENC  = 5e-5         # encoder base lr (layer-wise decay ile katmanlara dagilir)
LR_HEAD      = 1e-3         # decoder + channel_adapter
WEIGHT_DECAY = 0.05
LAYER_DECAY  = 0.75
MIXUP_ALPHA  = 0.2
LABEL_SMOOTH = 0.1
...
results = {
    "model": "SFM ViT-Base/16 full fine-tune (layer-wise LR + Lovasz + xline aug + ms-TTA)",
